    ...
    return (
      <div className="exam-list">
        ...
        <div className="status">
          <Breadcrumb>
            <BreadcrumbItem onClick={() => this.changeStatus('')}>
              <span style={{ cursor: 'pointer', color: '#000' }}>All</span>
            </BreadcrumbItem>
            <BreadcrumbItem onClick={() => this.changeStatus('pending')}>
              <span style={{ cursor: 'pointer' }} className="pending">
                Pending
              </span>
            </BreadcrumbItem>
            <BreadcrumbItem onClick={() => this.changeStatus('starting')}>
              <span style={{ cursor: 'pointer' }} className="starting">
                Starting
              </span>
            </BreadcrumbItem>
            <BreadcrumbItem onClick={() => this.changeStatus('ending')}>
